...
This desktop extension provides Skills, Plugins, Agents, MCPs, and Info views over the shared Codex PowerToys core. Install the generated VSIX with `code --install-extension <file>.vsix`.
